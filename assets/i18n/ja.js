...
export const UI_STRINGS_JA = Object.freeze({
  ...
  libraryViewToggleLabel: "表示切替",
  libraryViewSwitchToList: "一覧表示に切替",
  libraryViewSwitchToGrid: "グリッド表示に切替",
  librarySortDate: "読書日付",
  librarySortTitle: "書籍名",
  ...
  pageDirectionLabel: "綴じ方向",
  pageDirectionLtr: "左綴じ",
  pageDirectionRtl: "右綴じ",
  ...
  settingsLayoutDirectionRtl: "右綴じ (縦書き)",
  settingsLayoutDirectionLtr: "左綴じ (横書き)",
  ...
  pageDirectionLtrButton: "→左綴じ",
  pageDirectionRtlButton: "←右綴じ",
  readingDirectionLtrTitle: "左綴じ（左から右へ読む）",
  readingDirectionRtlTitle: "右綴じ（右から左へ読む）",
  zoomInTitle: "ズームする",
  zoomOutTitle: "ズームを解除",
