...
export const elements = {
    ...
    menuLang: getById(DOM_IDS.MENU_LANG),
    tocSection: getById(DOM_IDS.TOC_SECTION),
    tocSectionTitle: getById(DOM_IDS.TOC_SECTION_TITLE),
    tocList: getById(DOM_IDS.TOC_LIST),
    leftLangMenu: getById(DOM_IDS.LEFT_LANG_MENU),
    leftLangJa: getById(DOM_IDS.LEFT_LANG_JA),
    leftLangEn: getById(DOM_IDS.LEFT_LANG_EN),
    ...
    progressOverlay: getById(DOM_IDS.PROGRESS_OVERLAY),
    ...
    settingsProgressOverlay: getById(DOM_IDS.SETTINGS_PROGRESS_OVERLAY),
    settingsProgressOverlayLabel: getById(DOM_IDS.SETTINGS_PROGRESS_OVERLAY_LABEL),
    settingsProgressOverlayPosition: getById(DOM_IDS.SETTINGS_PROGRESS_OVERLAY_POSITION),
    settingsProgressOverlayPositionLabel: getById(DOM_IDS.SETTINGS_PROGRESS_OVERLAY_POSITION_LABEL),
    ...
    settingsLongPressZoomLabel: getById(DOM_IDS.SETTINGS_LONG_PRESS_ZOOM_LABEL),
    settingsLongPressZoomScale: getById(DOM_IDS.SETTINGS_LONG_PRESS_ZOOM_SCALE),
    settingsLongPressZoomScaleLabel: getById(DOM_IDS.SETTINGS_LONG_PRESS_ZOOM_SCALE_LABEL),
